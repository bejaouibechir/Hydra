...
const CONFIG_FIELDS: Record<string, FieldDef[]> = {
  ...
  source_mysql:    [
    ...
    { key: 'query',    label: 'Requête SQL',  type: 'textarea', required: true },
  ],
  source_postgres: [
    { key: 'host',     label: 'Hôte',        type: 'text',   placeholder: 'localhost', required: true },
  ...
  transform_sort:      [
    ...
    { key: 'ascending', label: 'Ordre', type: 'select', options: ['true', 'false'] },
  ],
  transform_aggregate: [
  ...
  action_email: [
    ...
    { key: 'password',  label: 'Mot de passe SMTP', type: 'text' },
