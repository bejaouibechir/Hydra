...
class SchemaDetector:
    ...
    def infer_schema(
        ...
        # ✅ FIX: Sort by path (original key in field_stats) instead of name
        # Because nested fields have name transformed (customer.id -> customer_id)
        # but field_stats uses the original path as key
